...
<html>
 <head>
    ...
    <link rel ="stylesheet" href="<?php echo get_template_directory_uri();?>/static/css/sousaku.css" type="text/css">
    <link href="<?php echo get_stylesheet_directory_uri();?>/static/js/slick/slick/slick-theme.css" rel="stylesheet" type="text/css" media="screen">
    <link href="<?php echo get_stylesheet_directory_uri();?>/static/js/slick/slick/slick.css" rel="stylesheet" type="text/css" media="screen">
